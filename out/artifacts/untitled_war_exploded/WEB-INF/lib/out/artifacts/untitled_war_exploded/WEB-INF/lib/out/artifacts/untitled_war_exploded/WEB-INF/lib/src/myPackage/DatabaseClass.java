 ...
 public class DatabaseClass {
     ...
     public void delCourseCode(String fCourseID) {
         try {
     ...
     public Questions getQuestionIdDetails(String fQuesionID) {
         ...
         try {
             ...
             ResultSet rs = pstm.executeQuery();
             while (rs.next()) {
                 questionIdDetails = new Questions(rs.getInt(1), rs.getString(2), rs.getString(3), rs.getString(4), rs.getString(5), rs.getString(6), rs.getString(7), rs.getString(8)
                 );
             }
             pstm.close();
         } catch (SQLException ex) {
