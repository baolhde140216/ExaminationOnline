...
<div class="content-area">
    <div class="panel" style="position: relative;left: 250px;max-width: 600px;">
        ...
        <div class="content-area">
            <div class="panel" style="float: left;max-width: 600px">
                ...
                %>
                <br/>
                <a href="adm-page.jsp?pgprt=0&pedt=1"><span style="text-decoration: none!important;" class="add-btn">Edit Profile</span></a>
                <%
                } else {
                %><br/>
                <a href="std-page.jsp?pgprt=0&pedt=1"><span style="text-decoration: none!important;" class="add-btn">Edit Profile</span></a>
                <%
                    }
                %>
                    ...
                    <form action="UserController">
                        ...
                        <table>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="password" value="" name="pass" class="text"
